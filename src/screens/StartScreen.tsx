            ...
            >
              ...
              <div className="px-5 sm:px-7 py-5 space-y-5 text-xs sm:text-sm">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {[
                      { icon: "🌅", time: "Sáng", desc: "Sự kiện bắt đầu xuất hiện. Mỗi sự kiện có đồng hồ đếm ngược — chọn nhanh trước khi hết giờ! Nếu hết giờ mà không chọn, game tự chọn phương án mặc định (thường không tốt lắm)." },
                      { icon: "☀️", time: "Trưa", desc: "Sự kiện dồn dập hơn và khó hơn. Bạn sẽ có giờ nghỉ trưa để vào Shop mua đồ hồi phục bằng lương tích lũy." },
                      { icon: "🌆", time: "Chiều", desc: "Giai đoạn căng thẳng nhất. Sự kiện có thể xuất hiện 2 cái cùng lúc! Giữ bình tĩnh, ưu tiên xử lý sự kiện nào có timer ngắn hơn trước." },
                      { icon: "🌙", time: "Tối", desc: "Kết thúc ngày — bạn chọn cách nghỉ ngơi để chuẩn bị cho ngày mai." },
                    ].map((item) => (
